...
import static edu.hm.hafner.pit.suppress.assertions.Assertions.*;
...
class FilteredLogTest extends SerializableTest<FilteredLog> {
    ...
    void shouldLogAllErrors() {
        ...
        Assertions.assertThat(filteredLog.size()).isEqualTo(5);
    }
    ...
    void shouldMergeLogger() {
        ...
        Assertions.assertThat(parent.size()).isEqualTo(1);
    }
    ...
    void shouldSkipEmptyErrorLogWhenMerging() {
        ...
        Assertions.assertThat(parent.size()).isZero();
    }
    ...
    void shouldLog20ErrorsByDefault() {
        ...
        Assertions.assertThat(filteredLog.getErrorMessages()).hasSize(22)
                .contains(TITLE)
                .contains("error19")
                .doesNotContain("error20")
                .contains("  ... skipped logging of 5 additional errors ...");
        Assertions.assertThat(filteredLog.getInfoMessages()).hasSize(25)
                .contains("info0")
                .contains("info24");
    }
    ...
    /** Actually tests {@link SerializableTest}. */
    @Test
